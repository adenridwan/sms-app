...
export default function Reports() {
    ...
    const loadDashboard = useCallback(async () => {
        setLoading(true);
        try {
            const response = await financeReportsApi.dashboard({
    ...
    const loadOutstanding = useCallback(async () => {
        setLoading(true);
        try {
            const response = await financeReportsApi.outstanding({
                ...outstandingFilters,
            ...
            setOutstandingMeta(response.data.meta);
        } catch (error) {
    ...
    const loadClassroomReport = useCallback(async () => {
        setLoading(true);
        try {
            const response = await financeReportsApi.byClassroom({
                academic_year_id: classroomYearId || undefined,
            });
            setClassroomData(response.data.data || []);
            setClassroomSummary(response.data.summary);
        } catch (error) {
    ...
    const loadMonthly = useCallback(async () => {
        setLoading(true);
        try {
            const response = await financeReportsApi.monthly({
            ...
            setMonthlyMeta(response.data.meta);
        } catch (error) {
